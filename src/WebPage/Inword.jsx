...
<hr className="hr_color" />
            ...
            <div className="col-md-12 mt-3">
              ...
              <input type="text" id="name1" name={"stockName"} className="form-control" />
            </div>
            <div className="col-md-12  mt-3">
              <label htmlFor="quantity">Quantity</label>
              <input type="number" id="quantity" name={"stockQuantity"} className="form-control" />
            </div>
            <div className="col-md-12 text-center mt-4">
              <button className="btn btn-light bttonn-color btn-lg  w-25"><span className="text-size">Save</span></button>
            </div>
          </div>
